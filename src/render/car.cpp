...
Car::Car(Vect3 setPosition, Vect3 setDimensions, Color setColor, float setVelocity, float setAngle, float setLf,
         std::string setName)
...
Eigen::Quaternionf Car::getQuaternion(float theta) const {
...
bool Car::checkCollision(const Vect3 &point) const {
